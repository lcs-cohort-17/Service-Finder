...
export const SearchBar: React.FC<SearchBarProps> = ({
  ...
  // Prefer real, already-filtered results from the parent. Fall back to the
  // built-in mock list only when the component is used standalone (no
  // results prop passed in) — e.g. isolated testing.
